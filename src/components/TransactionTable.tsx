      ...
      <table className="w-full min-w-[480px] text-xs sm:text-sm">
        <thead>
          <tr className="border-b border-slate-200 dark:border-slate-700 bg-slate-50/80 dark:bg-slate-800/80">
            <th className="px-2 sm:px-4 py-2 sm:py-3 text-left font-medium text-slate-600 dark:text-slate-400">Date</th>
            <th className="px-2 sm:px-4 py-2 sm:py-3 text-left font-medium text-slate-600 dark:text-slate-400">Type</th>
            <th className="px-2 sm:px-4 py-2 sm:py-3 text-left font-medium text-slate-600 dark:text-slate-400">Category</th>
            <th className="px-2 sm:px-4 py-2 sm:py-3 text-right font-medium text-slate-600 dark:text-slate-400">Amount</th>
            {onDelete && <th className="w-10 sm:w-12" />}
          </tr>
        </thead>
        <tbody>
          {transactions.map((t) => (
